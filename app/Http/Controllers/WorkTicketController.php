...
class WorkTicketController extends Controller
{
    ...
    private function storeRules(bool $external): array
    {
        ...
        return [
            'selections' => ['required_without_all:floors,extra_work_item_ids,shop_work_activity_ids,general_work', 'array', 'min:1'],
            ...
            'floors' => ['required_without_all:selections,extra_work_item_ids,shop_work_activity_ids,general_work', 'array'],
            'floors.*.included' => ['nullable'],
            'floors.*.scope' => ['nullable', 'in:entire,rooms'],
            'floors.*.area_ids' => ['nullable', 'array'],
            'floors.*.area_ids.*' => ['integer'],
            'work_item_ids' => ['required_without_all:selections,extra_work_item_ids,shop_work_activity_ids,general_work', 'array', 'min:1'],
    ...
    {
        return [
            'selections.required' => 'Voeg minstens één selectie toe, of kies algemeen werk of winkelwerk.',
            'selections.required_without_all' => 'Voeg minstens één selectie toe, of kies algemeen werk of winkelwerk.',
            'selections.min' => 'Voeg minstens één selectie toe, of kies algemeen werk of winkelwerk.',
            'floors.required_without_all' => 'Kies ruimtes, algemeen werk of winkelwerk.',
            'work_item_ids.required_without_all' => 'Kies ruimtes, algemeen werk of winkelwerk.',
