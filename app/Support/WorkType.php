...
class WorkType
{
    ...
    private static function matchType(string $value): ?string
    {
        ...
        return match (true) {
            ...
            str_contains($flat, 'linoleum') || str_contains($flat, 'marmoleum') || str_contains($flat, 'marmorette') || str_contains($flat, 'lino art') => 'Linoleum',
            str_contains($flat, 'mipolam') => 'Vinyl',
            str_contains($flat, 'surestep') => 'PVC',
