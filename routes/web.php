...
use App\Http\Controllers\PersonnelHoursController;
...
use App\Http\Controllers\VakmanTimeEntryController;
...
Route::middleware(['auth', EnsureProjectAccess::class, DenyReadOnlyWrites::class])->group(function () {
    ...
    Route::get('/mijn-planning/uren', [VakmanHoursController::class, 'index'])->name('vakman.hours.index');
    Route::get('/mijn-planning/dag/{date}/uren', [VakmanTimeEntryController::class, 'create'])->where('date', '\d{4}-\d{2}-\d{2}')->name('vakman.hours.create');
    Route::post('/mijn-planning/uren', [VakmanTimeEntryController::class, 'store'])->name('vakman.hours.store');
    Route::patch('/mijn-planning/uren/{timeEntry}', [VakmanTimeEntryController::class, 'update'])->name('vakman.hours.update');
    ...
    Route::get('/mijn-planning/tekeningen/{project}', [VakmanDrawingController::class, 'index'])->name('vakman.drawings.index');
    ...
    Route::post('/account-terug', [ImpersonateController::class, 'stop'])->name('users.impersonate.stop');
    ...
    Route::patch('/personeel/{worker}/leden/{crewMember}/uren-registreren', [PersonnelHoursController::class, 'updateMemberSetting'])->name('personnel.hours.member-setting');
